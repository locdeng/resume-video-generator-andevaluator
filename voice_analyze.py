...
from utils.audio_analysis import analyze_speech_rate, count_filler_words, sentence_length,detect_pauses,measure_loudness,analyze_pitch
...
if uploaded_file is not None:
    ...
    if st.button("📝 Transcribe Now"):
        ...
        st.write(f"✅ 말 속도 평균: {avg_speech_rate:.2f} từ/phút")
        ...
        # Lưu kết quả phân tích vào session_state
    ...
    # Nút Insight chỉ hiển thị nếu đã có kết quả
